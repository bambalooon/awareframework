...
//    }
    ...
    private void esm() {
        ...
        esm.setChecked(Aware.getSetting(getContentResolver(),"status_esm").equals("true"));
    ...
    private void temperature() {
        ...
        temperature.setChecked(Aware.getSetting(getContentResolver(),"status_temperature").equals("true"));
    ...
    private void accelerometer() {
        ...
        accelerometer.setChecked(Aware.getSetting(getContentResolver(),"status_accelerometer").equals("true"));
    ...
    private void linear_accelerometer() {
        ...
        linear_accelerometer.setChecked(Aware.getSetting(getContentResolver(),"status_linear_accelerometer").equals("true"));
    ...
    private void applications() {
        ...
        notifications.setChecked(Aware.getSetting(getContentResolver(), Aware_Preferences.STATUS_NOTIFICATIONS).equals("true"));
        ...
        crashes.setChecked(Aware.getSetting(getContentResolver(), Aware_Preferences.STATUS_CRASHES).equals("true"));
        ...
        if( Aware.getSetting(getContentResolver(), "status_applications").equals("true") && !isAccessibilityServiceActive() ) {
            showDialog(Aware_Preferences.DIALOG_ERROR_ACCESSIBILITY);
            Aware.setSetting(getContentResolver(),"status_applications","false");
            framework.stopApplications();
        }
        applications.setChecked(Aware.getSetting(getContentResolver(), Aware_Preferences.STATUS_APPLICATIONS).equals("true"));
        ...
        installations.setChecked(Aware.getSetting(getContentResolver(),"status_installations").equals("true"));
    ...
    private void battery() {
        ...
        battery.setChecked(Aware.getSetting(getContentResolver(),"status_battery").equals("true"));
    ...
    private void bluetooth() {
        ...
        bluetooth.setChecked(Aware.getSetting(getContentResolver(),"status_bluetooth").equals("true"));
    ...
    private void communication() {
        ...
        calls.setChecked(Aware.getSetting(getContentResolver(),"status_calls").equals("true"));
        ...
        messages.setChecked(Aware.getSetting(getContentResolver(),"status_messages").equals("true"));
        ...
        communication.setChecked(Aware.getSetting(getContentResolver(),"status_communication").equals("true"));
    ...
    private void gravity() {
        ...
        gravity.setChecked(Aware.getSetting(getContentResolver(),"status_gravity").equals("true"));
    ...
    private void gyroscope() {
        ...
        gyroscope.setChecked(Aware.getSetting(getContentResolver(),"status_gyroscope").equals("true"));
    ...
    private void locations() {
        ...
        location_gps.setChecked(Aware.getSetting(getContentResolver(),"status_location_gps").equals("true"));
        ...
        location_network.setChecked(Aware.getSetting(getContentResolver(),"status_location_network").equals("true"));
    ...
    private void network() {
        ...
        network_traffic.setChecked(Aware.getSetting(getContentResolver(),"status_network_traffic").equals("true"));
        ...
        network.setChecked(Aware.getSetting(getContentResolver(),"status_network").equals("true"));
    ...
    private void screen () {
        ...
        screen.setChecked(Aware.getSetting(getContentResolver(),"status_screen").equals("true"));
    ...
    private void wifi() {
        ...
        wifi.setChecked(Aware.getSetting(getContentResolver(),"status_wifi").equals("true"));
    ...
    private void processor() {
        ...
        processor.setChecked(Aware.getSetting(getContentResolver(),"status_processor").equals("true"));
    ...
    private void timeZone() {
        ...
        timeZone.setChecked(Aware.getSetting(getContentResolver(),STATUS_TIMEZONE).equals("true"));
    ...
    private void light() {
        ...
        light.setChecked(Aware.getSetting(getContentResolver(),"status_light").equals("true"));
    ...
    private void magnetometer() {
        ...
        magnetometer.setChecked(Aware.getSetting(getContentResolver(),"status_magnetometer").equals("true"));
    ...
    private void barometer() {
        ...
        pressure.setChecked(Aware.getSetting(getContentResolver(),"status_barometer").equals("true"));
    ...
    private void proximity() {
        ...
        proximity.setChecked(Aware.getSetting(getContentResolver(),"status_proximity").equals("true"));
    ...
    private void rotation() {
        ...
        rotation.setChecked(Aware.getSetting(getContentResolver(),"status_rotation").equals("true"));
    ...
    private void telephony() {
        ...
        telephony.setChecked(Aware.getSetting(getContentResolver(),"status_telephony").equals("true"));
    ...
    private void mqtt() {
        ...
        mqtt.setChecked(Aware.getSetting(getContentResolver(),"status_mqtt").equals("true"));
